  ...
  <div class = "inform-region container-fluid">
    <div class = "competencies">
      <div class = "container">
        ...
        <div class = "row competencies-row row-flex mt-3 mb-3 ">
                ...
                <div class = "competency-header">
                  <div class = "competency-icon">
                    <div class = "container">
                      ...
                      <img src = "../assets/img/competency-5.svg" alt = "competency-5" class = "img-responsive position-relative mt-3" style = "margin-left: 3em"/>
                    </div>
                  </div>
                </div>
              ...
              <div class = "competency-wrapper">
                <div class = "competency-header">
                  <div class = "competency-icon">
                    <div class = "container">
                      <img src = "../assets/img/druplar-logo.svg" alt = "druplar-logo" class = "position-absolute logoForOpacity mt-3"/>
                      <img src = "../assets/img/competency-6.svg" alt = "competency-6" class = "img-responsive position-relative mt-3" style = "margin-left: 3em"/>
                    </div>
                  </div>
                </div>
              ...
              <div class = "competency-wrapper">
                <div class = "competency-header">
                  <div class = "competency-icon">
                    <div class = "container">
                      <img src = "../assets/img/druplar-logo.svg" alt = "druplar-logo" class = "position-absolute logoForOpacity mt-3 "/>
                      <img src = "../assets/img/competency-7.svg" alt = "competency-7" class = "img-responsive position-relative mt-3" style = "margin-left: 3em"/>
                    </div>
                  </div>
                </div>
              ...
              <div class = "competency-wrapper">
                <div class = "competency-header">
                  <div class = "competency-icon">
                    <div class = "container">
                      <img src = "../assets/img/druplar-logo.svg" alt = "druplar-logo" class = "position-absolute logoForOpacity mt-3"/>
                      <img src = "../assets/img/competency-8.svg" alt = "competency-8" class = "img-responsive position-relative mt-3" style = "margin-left: 3em"/>
                    </div>
                  </div>
                </div>
